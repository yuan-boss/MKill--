...
import com.yuan.seckill.config.AccessLimit;
...
public class SecKillController implements InitializingBean {
    ...
    /**
     * @Author yuan_boss
     * @Description 秒杀(前后端分离)
     * @Date 14:24 2022/8/23
     * @Param
     * @return
     **/
...
//        SeckillOrder secKillOrder = seckillOrderService.getOne(new QueryWrapper<SeckillOrder>().eq("user_id", user.getId()).eq("goods_id", goodsId));
     ...
     * @Author yuan_boss
     * @Description 获取秒杀地址
     * @Date 15:37 2022/8/25
     * @Param
     * @return
     **/
    @AccessLimit(second=5,maxCount=5,needLogin=true) //限制访问次数，5秒内访问5次
